...
//@interface opensauceObject : NSObject
//@end

@interface opensauceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[opensauceObject class]])
		{
			for (NSString *key in [[(opensauceObject*)o modules] allKeys])
			{
