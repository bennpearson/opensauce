...
// in simulator we redefine to format for opensauce Developer console
...
{\
	NSString * exceptionName = [@"org.opensauce." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.opensauce";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIopensauceNativeItemNone = -1, 
	UIopensauceNativeItemSpinner = -2,
	UIopensauceNativeItemProgressBar = -3,
	
	UIopensauceNativeItemSlider = -4,
	UIopensauceNativeItemSwitch = -5,
	UIopensauceNativeItemMultiButton = -6,
	UIopensauceNativeItemSegmented = -7,
	
	UIopensauceNativeItemTextView = -8,
	UIopensauceNativeItemTextField = -9,
	UIopensauceNativeItemSearchBar = -10,
	
	UIopensauceNativeItemPicker = -11,
	UIopensauceNativeItemDatePicker = -12,
	
	UIopensauceNativeItemInfoLight = -13,
	UIopensauceNativeItemInfoDark = -14,
	
	UIopensauceNativeItemDisclosure = -15,
	
	UIopensauceNativeItemContactAdd = -16
};
